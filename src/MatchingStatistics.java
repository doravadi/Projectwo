...
public final class MatchingStatistics implements Serializable {
    ...
    public int getExcellentMatches() {
    ...
    public int getFairMatches() {
        return fairMatches;
    }

    public int getPoorMatches() {
        return poorMatches;
    }
    ...
    public static class Builder {
        ...
        public Builder medianScore(double medianScore) {
        ...
        public Builder excellentMatches(int excellentMatches) {
            this.excellentMatches = excellentMatches;
            return this;
        }

        public Builder goodMatches(int goodMatches) {
            this.goodMatches = goodMatches;
            return this;
        }

        public Builder fairMatches(int fairMatches) {
            this.fairMatches = fairMatches;
            return this;
        }

        public Builder poorMatches(int poorMatches) {
            this.poorMatches = poorMatches;
            return this;
        }
