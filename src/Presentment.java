...
public final class Presentment implements Comparable<Presentment>, Serializable {
    ...
    public PresentmentType getType() {
        return type;
    }
    ...
    public PresentmentStatus getStatus() {
        return status;
    }
    ...
    public static class Builder {
        ...
        public Builder type(PresentmentType type) {
            this.type = type;
            return this;
        }

        public Builder originalAuthId(String originalAuthId) {
        ...
        public Builder status(PresentmentStatus status) {
            this.status = status;
            return this;
        }
