...
public final class DatabaseStatistics implements Serializable {
    ...
    public Map<String, Long> getBankDistribution() { return bankDistribution; }
    public Map<String, Long> getCountryDistribution() { return countryDistribution; }
    public Map<String, Long> getCardTypeDistribution() { return cardTypeDistribution; }
    public long getTotalBinCoverage() { return totalBinCoverage; }
    public BinRange getLargestRange() { return largestRange; }
    public BinRange getSmallestRange() { return smallestRange; }
    ...
    public static class Builder {
        ...
        public Builder bankDistribution(Map<String, Long> distribution) { this.bankDistribution = distribution; return this; }
        public Builder countryDistribution(Map<String, Long> distribution) { this.countryDistribution = distribution; return this; }
        public Builder cardTypeDistribution(Map<String, Long> distribution) { this.cardTypeDistribution = distribution; return this; }
        public Builder totalBinCoverage(long coverage) { this.totalBinCoverage = coverage; return this; }
        public Builder largestRange(BinRange range) { this.largestRange = range; return this; }
        public Builder smallestRange(BinRange range) { this.smallestRange = range; return this; }

        public DatabaseStatistics build() { return new DatabaseStatistics(this); }
    }
}